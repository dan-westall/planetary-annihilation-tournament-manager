...
class WPTM_Tournament_Signup {
    ...
    public static function register() {
        ...
        add_action( 'wp_ajax_player_signup', [ $plugin, 'ajax_player_signup'] );
        add_action( 'wp_ajax_nopriv_player_signup',  [ $plugin, 'ajax_player_signup' ] );
    ...
    public static function ajax_player_signup(){
        ...
        try{
            ...
            if($signup->is_existing_player($signup_data)){
                ...
                if( true !== ( $can_join_tournament = apply_filters( 'can_join_tournament', true, $tournament_id, $signup->is_existing_player($signup_data) ) ) ){
                    ...
                    throw new Exception('Sorry you cannot join this tournament.');
