            ...
            array (
                ...
                'layouts' => array (
                        ...
                        'sub_fields' => array (
                            array (
                                ...
                                'sub_fields' => array (
                                    ...
                                    array (
                                        'key' => 'field_5407471206d46',
                                        'label' => 'Column Max Width',
                                        'name' => 'column_max_width',
                                        'type' => 'number',
                                        'instructions' => 'Max width of column, for example if you want the column to be half the width of page and the page has a max width of 12. enter 6 , if there was only 1 column then that 1 column would also then be centered',
                                        'column_width' => '',
                                        'default_value' => '',
                                        'placeholder' => '',
                                        'prepend' => '',
                    ...
                    array (
                        ...
                        'sub_fields' => array (
                            array (
                                'key' => 'field_54071b114ce4d',
                                'label' => 'Columns',
                                'name' => 'columns',
                                'type' => 'repeater',
                                'instructions' => 'Max of 3 for feature columns because of the image at the column top',
                                'column_width' => '',
                                'sub_fields' => array (
                                    array (
                                        'key' => 'field_54071b1f4ce4e',
                                        'label' => 'Column Image',
                                        'name' => 'column_image',
                                        'type' => 'image',
                                        'column_width' => '',
        ...
        'location' => array (
            array (
                array (
                    'param' => 'page_template',
                    'operator' => '==',
                    'value' => 'template-page-custom-layout.php',
                    'order_no' => 0,
                    'group_no' => 0,
                ),
            ),
